...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool noiseLevelExceeded)
{
    ...
    else
    {
        ...
        Map_Add(properties, "noiseLevelExceeded", noiseLevelExceeded ? "true" : "false");
